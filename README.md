🟨 BREAKOUT GAME  
Projeto desenvolvido como prática de programação em C, utilizando a biblioteca Raylib, recriando o clássico Breakout com um visual mais moderno, fundo personalizado e física aprimorada.

📚 Descrição  
O jogo consiste em controlar uma barra (paddle) para rebater a bola e destruir todos os tijolos.  
...
### ❗ raylib not found  
Certifique-se de que a Raylib está instalada corretamente e que está no caminho da sua toolchain.
